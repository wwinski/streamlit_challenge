...
# Page configs
st.set_page_config(page_title='Streamlit Day 8', page_icon=':sunglasses:', layout='centered')

# Streamlit Header
st.header('Examples: st.slider')

# Example 1 - Numeric Slider and output
st.subheader('Slider')
